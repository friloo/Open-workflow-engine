...
<div class="wrap">
    ...
    <div class="alert-ok">
        <strong>Backup erfolgreich eingespielt.</strong> Alle Benutzer, Workflows, Dokumente und Anhaenge aus dem Backup sind jetzt verfuegbar.
    </div>
    ...
    <ol style="font-size:14px; line-height:1.7; color:#334155;">
        ...
        <li>Pruefe unter <em>Verwaltung → E-Mail-Postfaecher</em>, ob die IMAP-Verbindungen vom neuen Host aus klappen (Test-Button).</li>
        ...
        <li>System-Health unter <em>Verwaltung → System-Health</em> einmal pruefen.</li>
    </ol>
