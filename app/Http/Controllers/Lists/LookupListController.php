...
class LookupListController extends Controller
{
    ...
    {
        $lists = LookupList::withCount('entries')->orderBy('name')->paginate(25);
    ...
    public function edit(LookupList $list): View
    {
        $entries = $list->entries()->orderBy('key_value')->paginate(50);
        return view('lists.edit', compact('list', 'entries'));
    }
    ...
    public function destroy(LookupList $list): RedirectResponse
    {
